                    ...
                    <div class="header-wrapper clearfix">
                        ...
                        <nav class="navigation closed clearfix">
                            ...
                            <ul class="sf-menu nav">
                                ...
                                <li><a href="#prevent">Pre-event</a></li>     
                            </ul>
                        </nav>
                        <!-- /Navigation -->
                ...
                <section class="page-section" id="about">
                    <div class="container">
                        <h1 class="section-title">
                            ...
                            <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">About Event <small></small></span>
                        </h1>
                        <div class="row">
                            <div class="col-lg-8">
                                <p data-animation="fadeInUp" data-animation-delay="300">Step into a realm of spiritual awakening and divine encounters. You are invited to a remarkable worship gathering featuring where globally acclaimed evangelist Pastor Benny Hinn will deliver the Gospel of Jesus, in Nairobi, Kenya. This isn’t just an event, it’s your personal invitation to partake in a transformative experience where worship, the good news, and miracles interweave by the guidance of the Holy Spirit.”
                                ...
                                <div id="tab-first" class="tab-pane fade in active">
                                    <div class="schedule-tabs lv2">
                                        <ul id="tabs-lv21"  class="nav nav-justified">
                                            <li class="active"><a href="#tab-lv21-first" data-toggle="tab">EVENT DETAILS</a></li>
            ...
            <footer class="footer">
                <div class="footer-meta">
                    <div class="container text-center">
                        ...
                        <span class="copyright" data-animation="fadeInUp" data-animation-delay="100">&copy; 2024 Tuombe Kenya &#8212; Prayers for the nation</span>
                    </div>
                </div>
            </footer>
            <!-- /FOOTER -->
